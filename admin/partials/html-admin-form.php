			...
			<tr valign="top">
				...
				<td>
					<select id="showname" name="showname" required>
						...
						<option <?php if ( get_option( 'showname' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showname' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showimage" name="showimage" required>
						...
						<option <?php if ( get_option( 'showimage' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showimage' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="attribute" name="attribute" required>
						...
						<option <?php if ( get_option( 'attribute' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'attribute' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showmfk" name="showmfk" required>
						...
						<option <?php if ( get_option( 'showmfk' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showmfk' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showdesc" name="showdesc" required>
						...
						<option <?php if ( get_option( 'showdesc' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showdesc' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showsku" name="showsku" required>
						...
						<option <?php if ( get_option( 'showsku' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showsku' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showprice" name="showprice" required>
						...
						<option <?php if ( get_option( 'showprice' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showprice' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showquantity" name="showquantity" required>
						<option <?php if ( get_option( 'showquantity' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showquantity' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showlink" name="showlink" required>
						<option <?php if ( get_option( 'showlink' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showlink' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="instock" name="instock" required>
						<option <?php if ( get_option( 'instock' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'instock' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="showaddtocart" name="showaddtocart" required>
						<option <?php if ( get_option( 'showaddtocart' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'showaddtocart' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="redirect" name="redirect" required>
						<option <?php if ( get_option( 'redirect' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'redirect' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
			...
			<tr valign="top">
				...
				<td>
					<select id="redirect" name="reload" required>
						<option <?php if ( get_option( 'reload' ) == "y" ) {
							echo "selected";
						} ?> value="y" ;>Yes
						</option>
						<option <?php if ( get_option( 'reload' ) == "n" ) {
							echo "selected";
						} ?> value="n">No
						</option>
