...
ini_set('display_errors', 1);
		...
		$html .= "\n" ;
                $html .= "<thead><tr style=''>\n" ;
               if( 'y' == $params['showimage'] )  $html .= "<th class='img header_class' style='text-align:center;'>Image</th>\n" ;
                if( 'y' == $params['showname'] ) $html .= "<th class='header_class' style='text-align:center;'>Product</th>\n" ;
                if( 'y' == $params['showsku'] ) $html .= "<th class='header_class' style='text-align:center;'>SKU</th>\n" ;

               if( 'y' == $params['attribute'] ) $html .= "<th class='attibute header_class' style='text-align:center;'>Attributes</th>\n" ;
                if( 'y' == $params['showmfk'] )     $html .= "<th style='text-align:center;' class='brands header_class'>Manufacturer</th>\n" ;
                $html .= "<th style='text-align:center;' class='cats header_class'>All Categories</th>\n" ;
                if( 'y' == $params['showdesc'] )  $html .= "<th class='desc header_class'>Description</th>\n" ;
          	  if( 'y' == $params['instock'] ) $html .= "<th class='instock header_class'>In Stock</th>\n" ;
                 if( 'y' == $params['showprice'] ) $html .= "<th class='price header_class'>Price</th>\n" ;
			
                if( 'y' == $params['showaddtocart'] )  $html .= "<th class='qty header_class'>Qty</th>\n" ;
                   $html .= "</tr></thead><tbody>\n" ;
		...
		$html .= $end ;
               ...
               if( 'y' == $params['showname'] ) $html .= "<th style='text-align:center;'></th>\n" ;
                ...
                if( 'y' == $params['showmfk'] ) $html .= "<th style='text-align:center;'></th>\n" ;
                $html .= "<th style='text-align:center;'></th>\n" ;
                if( 'y' == $params['showdesc'] )  $html .= "<th></th>\n" ;
                 	  if( 'y' == $params['instock'] ) $html .= "<th style='text-align:center;'></th>\n" ;   
                 if( 'y' == $params['showprice'] ) $html .= "<th colspan='2' class='qty_bottom'>
                                                            <div class='taxfinal'>
                                                            <div style='float:left;'> Tax: </div>
                                                            <div style='margin-left:5px;float:left;' id='prodtax".$formclass."'>0</div>
		 ...
		 if( 'y' == $params['showaddtocart'] ) {
                ...
                $html .= ' </table><div id="'.$formclass.'error_1" ></div>';
				if( 'y' == $params['showaddtocart'] ) { 
 ...
 ?>
    ...
    <a href="http://flance.info/multi/test/" style="display: none"> Demo site show Mulptiple product show </a>
