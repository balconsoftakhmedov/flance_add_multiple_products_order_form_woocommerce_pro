...
class Flance_Add_Multiple_Products_order_form_Woocommerce_Widget extends WP_Widget {
    ...
    public function __construct() {
	    parent::__construct(
	        ...
	        // name of the widget
	        __( 'Flance Add Multiple Products order form for Woocommerce', 'flance-add-multiple-products-order-form-woocommerce' ),
	        // widget options
	        array (
				'classname' 	=>	'flance-amp-widget',
	            'description' => __( 'Flance Add Multiple Products order form for Woocommerce Widget.', 'flance-add-multiple-products-order-form-woocommerce' )
	        )
	    );
    }
